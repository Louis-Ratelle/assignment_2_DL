...
#hidden size
#s_exec python ptb-lm.py --model=RNN --optimizer=ADAM --initial_lr=0.0001 --batch_size=20 --seq_len=35 --hidden_size=3000 --num_layers=2 --dp_keep_prob=0.35
#s_exec python ptb-lm.py --model=RNN --optimizer=ADAM --initial_lr=0.0001 --batch_size=20 --seq_len=35 --hidden_size=500 --num_layers=2 --dp_keep_prob=0.35

#s_exec python ptb-lm.py --model=RNN --optimizer=ADAM --initial_lr=0.0001 --batch_size=40 --seq_len=35 --hidden_size=1500 --num_layers=2 --dp_keep_prob=0.35
#s_exec python ptb-lm.py --model=RNN --optimizer=ADAM --initial_lr=0.0001 --batch_size=100 --seq_len=35 --hidden_size=1500 --num_layers=2 --dp_keep_prob=0.35

#GRU
#s_exec python ptb-lm.py --model=GRU --optimizer=SGD_LR_SCHEDULE --initial_lr=10 --batch_size=100 --seq_len=35 --hidden_size=1500 --num_layers=2 --dp_keep_prob=0.35
#s_exec python ptb-lm.py --model=GRU --optimizer=SGD_LR_SCHEDULE --initial_lr=10 --batch_size=15 --seq_len=35 --hidden_size=1500 --num_layers=2 --dp_keep_prob=0.35

#s_exec python ptb-lm.py --model=GRU --optimizer=SGD_LR_SCHEDULE --initial_lr=10 --batch_size=20 --seq_len=35 --hidden_size=1500 --num_layers=2 --dp_keep_prob=0.35 --emb_size=1000
#s_exec python ptb-lm.py --model=GRU --optimizer=SGD_LR_SCHEDULE --initial_lr=10 --batch_size=20 --seq_len=35 --hidden_size=1500 --num_layers=2 --dp_keep_prob=0.35 --emb_size=400

#Trans
s_exec python ptb-lm.py --model=TRANSFORMER --optimizer=SGD_LR_SCHEDULE --initial_lr=20 --batch_size=128 --seq_len=35 --hidden_size=512 --num_layers=6 --dp_keep_prob=0.9 --emb_size=1000
